...
(defparameter hyperspec-root "http://www.lispworks.com/reference/HyperSpec/Body/")

(defcommand clhs (symbol)
   (aif (assoc (string symbol) clhs-lookup :test #'equalp)
        (cats (first it) " ~ " hyperspec-root (second it))
        (format nil "couldn't find anything for '~a'" symbol)))
